...
public abstract class Classifier {
    public static final String TAG = "[IC]Classifier";

    private static final String MODEL_NAME = "lite-model_efficientdet_lite3_detection_default_1.tflite";
//    private static final String MODEL_NAME = "mobilenet_imagenet_model.tflite";
    private static final String LABEL_FILE = "label2.txt";
    ...
    public Classifier(@NonNull Context context, @NonNull Model model) {
