...
public class ClassifierBuilder {
    ...
    public static final String TAG = "[IC]ClassifierBuilder";
    ...
    public ClassifierBuilder(Context context) {
        Log.i(TAG, "ClassifierBuilder");
        this.context = context;
        this.device = Model.Device.CPU;
        this.nThread = 1;

        this.modelName = "lite-model_efficientdet_lite3_detection_default_1.tflite";
        this.imageMean = 0.0f;
...
//        return Model.createModel(context, modelName, optionsBuilder.build());
        Log.i(TAG, "createMultiThreadModel");
        return Model.createModel(context, modelName);
    }
